...
export class BinaryClockComponent
{
    ...
    @Input()
    set hour(v: string) {if (v !== this._hour) {this._hour = v; this.updateBits();}}
    @Input()
    set minute(v: string) {if (v !== this._minute) {this._minute = v; this.updateBits();}}
    @Input()
    set second(v: string) {if (v !== this._second) {this._second = v; this.updateBits();}}
    @Input()
    set period(v: string) {if (v !== this._period) {this._period = v; this.updateBits();}}
